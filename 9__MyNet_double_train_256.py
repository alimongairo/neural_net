...
data_path = ''
file_name = 'my_epoch6+6_size256.ptch'
...
optimizer = optim.AdamW(net.parameters(), lr=0.0001)  # optimizer function
extra_optimizer = optim.AdamW(net.parameters(), lr=0.00001)  # optimizer function
...
print('Finished Training with lr 10^(-4)')

torch.save(net.state_dict(), data_path + file_name + '_6_epochs')  # saving the model weights
